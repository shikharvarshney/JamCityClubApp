...
I know, this is not a good practice and I usually use the ```aws-sdk``` to create and SES object an then configure it to send Emails in my code. Since, I don't want to include any NPM package in here and just wanted to show that this functionality can work, I kept it that way. Thanks for understanding.
