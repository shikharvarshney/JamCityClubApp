...
<div id="prompt" class="col-sm-12">
    <form role="form" id="lineForm" class="form-horizontal">
        ...
        <div class="col-sm-2">
        <button  id="myButton" onclick="createClub()" class="btn btn-primary mb-1">Create Club</button>
        </div>
        <div class="col-sm-2">
...
function inviteUser() {
    ...
    if (mailID == null || mailID == "") {
        // I am not proficient at HTML but an error message should come here.
    } 
        ...
        var params = {
            ...
            Subject: {
                Charset: 'UTF-8',
                Data: 'Invite for Jam City Club App'
            }
            }
        };
